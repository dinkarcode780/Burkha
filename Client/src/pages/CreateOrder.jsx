...
const CreateOrder = () => {
  ...
  if (formData.amountPaid > formData.totalPriceAfterDiscount) {
  toast.error("Paid amount cannot be more than total after discount");
  return;
}
  ...
  // Remove leading zeros (but allow "0" if empty)
  ...
  // Ensure it never exceeds after discount
  amount = Math.min(amount, formData.totalPriceAfterDiscount);
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
  type="number"
  value={formData.amountPaid || ""}   // agar 0 hai to khali dikhega
  onChange={handleAmountPaidChange}
  className="w-full border rounded px-3 py-2"
  min="0"
  step="0.01"
