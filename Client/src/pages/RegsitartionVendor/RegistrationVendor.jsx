...
const RegistrationVendor = () => {
  ...
  <button
    onClick={() => handleEdit(row)}
    className="bg-blue-500 text-white px-2 py-1 rounded text-xs sm:text-sm hover:bg-blue-600"
  >
    Edit
  </button>
  <button
  ...
  return (
    <div className="container mx-auto px-10 py-8 ml-[7%]">
