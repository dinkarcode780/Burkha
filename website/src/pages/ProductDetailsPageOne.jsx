...
const ProductDetailsOne = () => {
  ...
  const openPrev = () => {
    const idx = sliderItems.indexOf(lbMedia ?? mainMedia);
    const prevIdx =
      idx > -1 ? (idx - 1 + sliderItems.length) % sliderItems.length : 0;
    const item = sliderItems[prevIdx];
    setLbMedia(item);
    setMainMedia(item);
    setZoom(1);
                      ...
                      {isLikelyImageUrl(mainMedia) ? (
                        <div
                          style={{
                            position: "relative",
                            width: "100%",
                            maxWidth: "380px", // control width like the phone in left image
                            margin: "0 auto",
                          }}
                        >
                          <ReactImageMagnify
                            {...{
                              ...
                              enlargedImageContainerStyle: {
                                ...
                                marginLeft: "20px", // spacing between left & zoom view
                              },
                              lensStyle: {
            ...
            >
              <img
                ...
                style={{
                  ...
                  userSelect: "none",
                  cursor:
                    zoom > 1 ? (isPanning ? "grabbing" : "grab") : "zoom-out",
                  boxShadow: "0 8px 30px rgba(0,0,0,0.6)",
                  display: "block",
                  maxWidth: "100%",
                  maxHeight: "100%",
