  ...
  return (
    <div className="feature " id="featureSection">
      <h4 className="text-center">
        Explore Our <span className="">Furniture</span> Range
      </h4>
                ...
                <div className="feature-item__thumb rounded-3">
                  <Link to="/shop" className="w-100 h-100 flex-center">
                    <img
                      ...
                      src="https://img.freepik.com/free-vector/muslim-girl-black-outfit_1308-20422.jpg?uid=R79748185&ga=GA1.1.1807792258.1717831286&semt=ais_hybrid&w=740"
                      alt=""
                    />
                  </Link>
                </div>
                ...
                <div className="feature-item__thumb rounded-3">
                  <Link to="/shop" className="w-100 h-100 flex-center">
                    <img
                      ...
                      src="https://img.freepik.com/free-vector/beautiful-arabic-lady-cartoon-character_1308-48006.jpg?uid=R79748185&ga=GA1.1.1807792258.1717831286&semt=ais_hybrid&w=740"
                      alt=""
                    />
                  </Link>
                </div>
                ...
                <div className="feature-item__thumb rounded-3">
                  <Link to="/shop" className="w-100 h-100 flex-center">
                    <img
                      ...
                      src="https://img.freepik.com/premium-vector/woman-wearing-niqab-islamic-traditional-veil-cartoon-character_1639-18099.jpg?uid=R79748185&ga=GA1.1.1807792258.1717831286&semt=ais_hybrid&w=740"
                      alt=""
                    />
                  </Link>
                </div>
